---
title: "Natal Coat Contrast to the Mother with Sexual Dichromatism"
...
## Natal Coat Contrast to the Mother with Sexual Dichromatism Regression

```{r Run-phylolm}
# run phylolm and get summary
CONMSDC <- phyloglm(ConM ~ Sexual_Dichromatism, data_pruned_rownames, phy = pruned.tree,method="logistic_MPLE")
summary(CONMSDC)
```
