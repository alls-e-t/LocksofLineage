---
title: "Natal Coat Contrast to Both Parents with Sexual Dichromatism"
...
## Natal Coat Contrast to Both with Sexual Dichromatism Regression

```{r Run-phylolm}
# run phylolm and get summary
CONBSDC <- phyloglm(ConB ~ Sexual_Dichromatism, data_pruned_rownames, phy = pruned.tree,method="logistic_MPLE")
summary(CONBSDC)
```
