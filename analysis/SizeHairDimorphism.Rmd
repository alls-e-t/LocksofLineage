---
title: "Hair Sexual Dimorphism with Size Dimorphism"
...
## Hair Sexual Dimorphism with Size Dimorphism Regression

```{r Run-phylolm}
# run phylolm and get summary
SizeHSD <- phyloglm(Sexual_Dimorphism ~ Size_Dimorphism, data_pruned_rownames, phy = pruned.tree,method="logistic_MPLE")
summary(SizeHSD)
```
