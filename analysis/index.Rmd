...
# Automated Model Regressions 
Click on this [link](binarized_logistic_regression.html) to see how I automated my logistics regression for all of my traits of interest. For this model the traits of interest are:

1. Presence of Sexual Dimorphism

  - whether sexual dimorphism is on the head
  
  - whether sexual dimorphism is expressed as male-directed growth from the juvenile state
  
2. Presence of Natal Coats

  - whether these natal coats were contrasting to both parents
  
  - just mom or dad
  
  - inconspicuous compared to the adult coat
  
3. Presence of Sexual Dichromatism

  - whether the males with sexual dichromatism were darker than the females
