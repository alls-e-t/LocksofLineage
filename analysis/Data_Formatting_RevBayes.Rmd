...
setwd("/Users/taysarah/Desktop/GitHub/LOL_RevBayes/bin/RB_Practice_Old_Data")
...
```{r Save-NEXUS-files}
write_custom_nexus_spaces(NCRB_Matrix, "data/NC_output_spaces.nex")
write_custom_nexus_spaces(SDRB_Matrix, "data/SD_output_spaces.nex")
```

## Run RevBayes
```{bash Pipeline-to-run-RevBayes}
#Running RevBayes
#cd ~/Desktop/GitHub/LOL_RevBayes/bin/RB_Practice_Old_Data/

#Open RevBayes software
#~/Desktop/GitHub/revbayes/bin/rb

#source("scripts/file.Rev")
```
