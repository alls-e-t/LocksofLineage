---
title: "Natal Coat Contrast to the Father with Sexual Dichromatism"
...
## Natal Coat Contrast to the Father with Sexual Dichromatism Regression

```{r Run-phylolm}
# run phylolm and get summary
CONDSDC <- phyloglm(ConD ~ Sexual_Dichromatism, data_pruned_rownames, phy = pruned.tree,method="logistic_MPLE")
summary(CONDSDC)
```
