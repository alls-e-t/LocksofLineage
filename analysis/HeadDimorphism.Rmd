---
title: "Sexual Dimorphism on the Head"
...
## Sexual Dimorphism on the Head Regression

```{r Run-phylolm}
# run phylolm and get summary
HeadSDM <- phyloglm(DM_Head ~ Sexual_Dimorphism, data_pruned_rownames, phy = pruned.tree,method="logistic_MPLE")
summary(HeadSDM)
```
