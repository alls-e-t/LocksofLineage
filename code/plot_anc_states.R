...
tree_file <- paste0("output/RevBayes/log/",CHARACTER,"_ase_ERM.tree")
...
ggsave(paste0("output/RevBayes/plots/Primates_",CHARACTER,"_ASE_ERM_MAP.pdf"), p, width = 14, height = 12)
...
ggsave(paste0("output/RevBayes/plots/Primates_",CHARACTER,"_ASE_ERM_Pie.pdf"), p, width = 14, height = 12)
