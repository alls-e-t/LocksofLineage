...
file <- paste0("output/Sex_Dichrom_output/",CHARACTER,"_irrev.log")
...
ggsave(paste0("output/Sex_Dichrom_output/Primates_",CHARACTER,"_irrev.pdf"), p, width = 5, height = 5)
...
ggsave(paste0("output/Sex_Dichrom_output/Primates_",CHARACTER,"_rates_irrev.pdf"), p, width = 5, height = 5)
