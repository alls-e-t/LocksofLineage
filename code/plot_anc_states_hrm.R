...
tree_file <- paste0("output/Sex_Dichrom_output/",CHARACTER,"_ase_hrm.tree")
...
ggsave(paste0("output/Sex_Dichrom_output/Primates_",CHARACTER,"_ASE_HRM_MAP.pdf"), p, width = 11, height = 9)
...
ggsave(paste0("output/Sex_Dichrom_output/Primates_",CHARACTER,"_ASE_HRM_Pie.pdf"), p, width = 11, height = 9)
